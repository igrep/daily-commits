...
- custard:
    - [ ] sum-moneyの改善
        - 設計:
            ...
            - 2026/01/31:
                - 昨日、要らないのではないかと懸念した関数は、実装を読む限り普通に使っていそう。テストが足りていないのだ。TODOにしておく
                - その他、ついでに見つかった箇所のリファクタリング
                - 明日一通りコミットしよう
            - 2026/02/01: 予定通り一通りコミット。明日は`meta.macro`のリネームの件かな
                - その前に、`meta.macroToFunction`を試しに使ってみたら、まだバグってる。難しいね
- 読書など:
